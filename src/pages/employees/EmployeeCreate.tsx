 ...
 * EmployeeCreate Page
 * ====================
 * Create new employee page with full onboarding (auth user + employee record)
 * Route: /employees/create
 * 
 * NOTE: This is a legacy page. Prefer using EmployeeFormDialog from EmployeesList.
 * This page is kept for backward compatibility and direct navigation.
 */

import { useState } from "react";
import { useNavigate } from "react-router-dom";
import { ArrowLeft, UserPlus, Eye, EyeOff, RefreshCw, Key, CheckCircle2, AlertCircle } from "lucide-react";
...
export default function EmployeeCreate() {
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="max-w-2xl border-blue-200 bg-blue-50/50">
        <CardHeader className="pb-3">
          ...
          <CardDescription>
            These credentials will allow the employee to log into the system.
          </CardDescription>
        </CardHeader>
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">
                  Leave empty to use the contact email from below.
                </p>
              </div>
              <div className="space-y-2">
