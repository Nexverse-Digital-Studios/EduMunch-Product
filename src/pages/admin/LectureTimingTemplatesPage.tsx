  ...
  return (
    <div className="min-h-screen bg-gray-50 dark:bg-dark-bg-primary">
      <div className="max-w-7xl mx-auto p-6">
        {/* Header */}
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-6">Lecture Timing Templates</h1>
        ...
        <div className="bg-white dark:bg-dark-surface-primary rounded-lg shadow p-4 mb-6">
          ...
          <div className="flex gap-4">
            <select
              ...
              className="flex-1 px-4 py-2 border border-gray-300 dark:border-dark-border-primary rounded-lg bg-white dark:bg-dark-surface-secondary text-gray-900 dark:text-white"
            >
          ...
          <div className="space-y-4">
            {DAYS_OF_WEEK.map(day => (
              <div key={day} className="bg-white dark:bg-dark-surface-primary rounded-lg shadow p-6 border border-gray-200 dark:border-dark-border-primary">
                <h2 className="text-lg font-bold text-gray-900 dark:text-white mb-4">{day}</h2>
                      ...
                      <div key={slot.id || index} className="flex gap-4 items-center bg-gray-50 dark:bg-dark-surface-secondary p-3 rounded-lg">
                        <div className="flex items-center gap-2 flex-1">
                          <input
                            ...
                            className="px-3 py-2 border border-gray-300 dark:border-dark-border-primary rounded-lg bg-white dark:bg-dark-surface-primary text-gray-900 dark:text-white"
                          />
