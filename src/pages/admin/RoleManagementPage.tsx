  ...
  return (
    <div className="p-8 bg-white dark:bg-dark-bg-primary">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        {loading ? (
          <div className="col-span-full text-center py-8 text-gray-500 dark:text-gray-400">Loading roles...</div>
        ) : roles.length === 0 ? (
          <div className="col-span-full text-center py-8 text-gray-500 dark:text-gray-400">No roles found</div>
        ) : (
          roles.map((role) => {
            ...
            return (
              <div
                key={role.id}
                className="rounded-lg border border-indigo-200 dark:border-indigo-500 p-6 hover:shadow-lg transition bg-white dark:bg-dark-surface-primary"
              >
                <div className="flex items-start justify-between mb-4">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    >
                      <Trash2 size={18} className={role.is_system_role ? 'text-gray-400 dark:text-gray-600' : 'text-red-600 dark:text-red-400'} />
                    </button>
                  </div>
                </div>
                ...
                <div className="mt-4 pt-4 border-t border-gray-200 dark:border-dark-border-primary">
                  ...
                  <button
                    className="mt-3 w-full py-2 rounded-lg text-sm font-semibold transition text-white bg-indigo-600 dark:bg-indigo-500 hover:bg-indigo-700 dark:hover:bg-indigo-600"
                  >
                    Manage Permissions
                  </button>
                </div>
