  ...
  return (
    <div className="space-y-6 animate-slide-in-left">
      ...
      <div className="flex flex-col sm:flex-row gap-4">
        <div className="flex-1 relative">
          ...
          <input
            type="text"
            placeholder="Search..."
            className="w-full pl-10 pr-4 py-2 border border-gray-200 dark:border-dark-border-primary rounded-lg bg-white dark:bg-dark-surface-secondary text-gray-900 dark:text-white placeholder-gray-400 dark:placeholder-dark-text-tertiary focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
        </div>
        <button className="flex items-center gap-2 px-4 py-2 border border-gray-200 dark:border-dark-border-primary rounded-lg bg-white dark:bg-dark-surface-secondary hover:bg-gray-50 dark:hover:bg-dark-surface-primary transition-colors text-gray-700 dark:text-white">
      ...
      <div className="bg-white dark:bg-dark-surface-primary rounded-lg border border-gray-200 dark:border-dark-border-primary p-12 text-center">
        ...
        <p className="text-gray-600 dark:text-slate-400 mb-4">Get started by creating your first item</p>
